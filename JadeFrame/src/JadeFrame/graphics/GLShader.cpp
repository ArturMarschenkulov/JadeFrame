...
auto GLShader::compile(GLenum type, const std::string& codeSource) -> GLuint {
...
auto GLShader::update_shader_variables(int shaderType) -> void {
	int num;
