...
auto Vec3::operator*(const float& other) const -> Vec3 {
...
auto Vec3::operator*=(const float& other) -> Vec3& {
	*this = *this * other;
	return *this;
}
auto Vec3::operator/=(const float& other) -> Vec3& {
...
auto Vec3::mult(const float o) const -> Vec3 {
	return Vec3(x * o, y * o, z * o);
}
auto Vec3::div(const float o) const -> Vec3 {
	return Vec3(x / o, y / o, z / o);
}
auto Vec3::get_length() const -> float {
	return std::sqrt(this->dot(*this));
}
auto Vec3::dot(const Vec3& o) const -> float {
