...
class VectorT<2, T> {
public:
	constexpr VectorT() noexcept : x(), y() {

	}
	constexpr VectorT(const T x, const T y) noexcept : x(x), y(y) {
...
class VectorT<3, T> {
public:
	constexpr VectorT() noexcept : x(), y(), z() {

	}
	constexpr VectorT(const T x, const T y, const T z) noexcept : x(x), y(y), z(z) {
...
class VectorT<4, T> {
public:
	constexpr VectorT() noexcept : x(), y(), z(), w() {

	}
	constexpr VectorT(const T x, const T y, const T z, const T w) noexcept : x(x), y(y), z(z), w(w) {
