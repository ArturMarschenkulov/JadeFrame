...
auto Windows_Window::get_title() const -> std::string {
	return m_title;
}
...
auto Windows_Window::set_window_state(const WINDOW_STATE window_state) -> void {
	m_window_state = window_state;
}

auto Windows_Window::get_window_state() const -> WINDOW_STATE {
